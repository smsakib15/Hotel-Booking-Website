        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active" style="margin-right:10px;">Canceled Order</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<?php
$result = mysqli_query($con, "SELECT * FROM user_order WHERE status = '3' ORDER BY id DESC ");
