...
<body>
  ...
  <div style="float:left; padding-left:150px; padding-top:100px;" class="table-main">
    <table border="0" ; width="700px" height="10px" align="center">
      <p style="font-family:Cinzel Decorative; color:#b0914f; font-size:24px;">Cart</p>
  ...
  <form style="padding-left: 350px;" action="submit.php" method="post">
    <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="<?php echo $publishableKey ?>" data-amount="<?php echo $print[6]; ?>" data-name="Osean Sunrise" data-description="Booking Hotel" data-image="https://www.logostack.com/wp-content/uploads/designers/eclipse42/small-panda-01-600x420.jpg" data-currency="BDT" data-email="greencommercial18@gmail.com">
    </script>
